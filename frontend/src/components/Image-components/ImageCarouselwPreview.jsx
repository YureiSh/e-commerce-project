        ...
        <section className="flex flex-col items-center">
            ...
            >
                ...
                <button
                    ...
                    className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/20 hover:bg-black/40 backdrop-blur-sm text-white rounded-full p-1 transition-all duration-200"
                >
                    <ChevronLeft size={36} />
                </button>
                ...
                <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/20 hover:bg-black/40 backdrop-blur-sm text-white rounded-full p-1 transition-all duration-200"
                >

...
export const categories = [
    { id: 1, url: "https://images.unsplash.com/photo-1546197244-cdd3a3fc80a1?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Jackies", count: 1, href:"/shop/" },
    ...
    return (
        <>
            <section className="bg-[#FAFAFA]">
                <div className="max-w-400 m-auto pt-8 pb-8 px-12 lg:px-0 flex justify-between">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-4 pb-8 justify-center">
                    {categories.map((item) => (
